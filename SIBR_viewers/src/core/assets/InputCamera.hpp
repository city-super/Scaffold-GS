	...
	*/
	...
	public:
		...
		*/
		...
		static std::vector<InputCamera::Ptr> InputCamera::loadCityTransform(const std::string& transformPath, const float zNear = 0.01f, const float zFar = 1000.0f, const int fovXfovYFlag = 0);
